...
import 'application/auth/sign_up/email_auth_form/email_auth_form_bloc.dart'
    as _i7;
import 'application/auth/sign_up/sign_up_form/sign_up_form_bloc.dart' as _i6;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i6.SignUpFormBloc>(
      () => _i6.SignUpFormBloc(get<_i3.IAuthRepository>()));
  gh.factory<_i7.EmailAuthFormBloc>(
      () => _i7.EmailAuthFormBloc(get<_i3.IAuthRepository>()));
  return get;
}
