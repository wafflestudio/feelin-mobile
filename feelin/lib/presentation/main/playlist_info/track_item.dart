              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        if(state.post.playlist.tracks![index].isExplicit) Padding(
                          padding: const EdgeInsets.only(right: 3),
                          child: Image.asset('assets/icons/19badge.png', width: 11, height: 11,),
                        ),
                        SizedBox(
                          width: state.post.playlist.tracks![index].isExplicit ? MediaQuery.of(context).size.width - 120: MediaQuery.of(context).size.width - 106,
                          child: Text(
                            List.generate(state.post.playlist.tracks![index].artists.length, (index2) => state.post.playlist.tracks![index].artists[index2].name).join(", "),
